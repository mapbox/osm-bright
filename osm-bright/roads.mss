...
#tunnel[zoom >= 11] {
    ...
    ::inline {
        ...
        [stylegroup='motorway'] { line-color: lighten(@motorway_fill, 10%); }
        [stylegroup='mainroad'] { line-color: lighten(@primary_fill, 10%); }
        [stylegroup='minorroad'] { line-color: lighten(@secondary_fill, 10%); }
        [stylegroup='railway'] {
            line-color: @rail_line;
            line-dasharray: 1,1;
            [type='subway'] { line-opacity: 0.67; }
...
/* ---- Bridges -------------------------------- */
#bridge::outline[zoom>=11][zoom<=20]{
    /* -- colors & styles -- */
    line-cap: butt;
    line-join: round;
    line-color: @standard_case * 0.8;
    [stylegroup='motorway'] { line-color: @motorway_case * 0.8; }
    [stylegroup='mainroad'] { line-color: @primary_case * 0.8; }
    [stylegroup='minorroad'] { line-color: @secondary_case * 0.8; }
    [stylegroup='railway']  { line-color: @secondary_case * 0.8; }
